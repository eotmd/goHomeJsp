		...
		<form action="./boardUpdate" method="get">
			<table style="width: 800px; height: 800px;">
				<tr>
					...
					<td style="margin-right: 0px; width: 200px;">작성자(아이디): ${boardDto.id}</td>
				</tr>
				<tr>
			...
			<input type="button" value="뒤로가기" onclick="location.href ='/TeamSite/main'">
		</form>
	</c:if>
	<c:if test="${boardDto.mno == member.mno}">
		<form action="./boardUpdate" method="get">
			...
			<input type="submit" value="수정하기" onclick="location.href='./boardUpdate'">
			<input type="button" value="뒤로가기" onclick="location.href ='/TeamSite/main'">
		</form>
