	...
	<form action="./boardUpdate" method="post">
		...
		<table style="width: 800px; height: 800px;">
			<tr>
				...
				<td><input type="text" name="title" value="${boardDto.title}"
					style="width: 740px; height: 20px;"></td>
			</tr>
			<tr>
		...
		<input type="submit" value="수정완료"> <input type="reset"
			value="지우개"> <input type="button" value="뒤로가기"
			onclick="location.href ='./boarddetail?boardno=${boardDto.boardno}'">
	</form>
